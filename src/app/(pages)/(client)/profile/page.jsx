...
export default function ProfilePage() {
    ...
    const handleAddressChange = (field, value) => {
        const newData = {
            ...editData,
            adress: { ...editData.adress, [field]: value }
        };
        setEditData(newData);
        autoSave(newData);
    };
                    ...
                    <section className="min-h-screen rounded-[12px] lg:rounded-none p-4 lg:w-96 bg-white">
                        <div className="space-y-4">
                            <div className="mb-2 flex pt-10 py-5 items-center gap-3">
                                <div
                                    ...
                                    style={{
                                        background:
                                            "linear-gradient(135deg, #F10000, #C30000)"
                                    }}
                                >
                        ...
                        <div className="space-y-3">
                            ...
                            {renderAddressField(
                                "Город",
                                "city",
                                editData.adress?.city
                            )}
                            {renderAddressField(
                                "Улица",
                                "street",
                                editData.adress?.street
                            )}
                            {renderAddressField(
                                "Дом",
                                "house",
                                editData.adress?.house
                            )}
                        </div>
                    </section>

                    <section className="w-full lg:m-6 mt-6">
                        <div className="rounded-[12px] min-h-96 w-full bg-white px-6 py-5">
                        ...
                        <div className="flex flex-col lg:flex-row gap-6 mt-6">
                            <Link
                                href="/create"
                                className="relative bg-white w-full h-[300px] rounded-xl overflow-hidden p-6"
                            >
                            ...
                            <Link
                                href="/orders"
                                className="relative cursor-pointer bg-white w-full h-[300px] rounded-xl overflow-hidden p-6"
                            >
                                <h3 className="text-lg font-semibold">
                                    Скачать прайс-лист
                                </h3>
