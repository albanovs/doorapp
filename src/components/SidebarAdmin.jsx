...
const nav = [
    ...
    { href: "/admin/applications", icon: Grid },
    { href: "/admin/orders", icon: FileText },
    { href: "/admin/search", icon: Search },
    { href: "/admin/notif", icon: Bell },
];
        ...
        const fetchNotifications = async () => {
            ...
            try {
                ...
                if (res.ok && data.notifications) {
                    setHasNotifications(data.notifications.some(n => !n.isReadAdmin));
                }
            } catch (err) {
